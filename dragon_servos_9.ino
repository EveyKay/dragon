...
void rorAnimation() {
  ...
  const int returnSteps = 35;       // fewer steps than before = faster
  const int returnStepDelayMs = 12; // shorter delay per step = faster
...
void lookRightAnimation() {
  ...
  moveServosTogether(names, targets, 4, 40, 20);
}
