...
void rorAnimation() {
  ...
  for (int i = 0; i <= steps; i++) {
    ...
    // a hold in the middle so they stay closed a bit longer:
    // 0.00-0.30 = closing, 0.30-0.70 = holding closed, 0.70-1.00 = opening
    const float closeEnd = 0.30;
    const float holdEnd = 0.70;
